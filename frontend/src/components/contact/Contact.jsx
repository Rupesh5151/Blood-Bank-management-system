    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-white">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10 px-6">
          ...
          <div className="text-center shadow-md p-8 rounded-xl hover:shadow-xl transition">
            ...
            <p className="text-gray-600">+91 93349 23188</p>
          ...
          <div className="text-center shadow-md p-8 rounded-xl hover:shadow-xl transition">
            ...
            <p className="text-gray-600">Rungta college Bhilai, chhattisgarh</p>
            <p className="text-gray-600">India - 490023</p>
          </div>
        </div>
      </section>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-gray-700">+91 9334923188</span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700">Bhiali, chhattisgarh</span>
              </div>
            </div>
      ...
      <section className="mb-5">
        <iframe
          ...
          src="https://www.google.com/maps/embed?origin=mfe&pb=!1m3!2m1!1sBhilai!6i13"
          allowFullScreen
        ></iframe>
      </section>
